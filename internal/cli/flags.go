...
type Flags struct {
	...
	YouTubeVisual                   bool                 `long:"visual" yaml:"visual" description:"Extract visual data from video using OCR and FFmpeg"`
	YouTubeVisualSensitivity        float64              `long:"visual-sensitivity" yaml:"visualSensitivity" description:"Tolerance for FFmpeg scene detection (0.0 - 1.0)" default:"0.4"`
	YouTubeVisualFPS                int                  `long:"visual-fps" yaml:"visualFPS" description:"Extract a specific number of frames per second instead of using scene detection" default:"0"`
