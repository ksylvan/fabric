...
func GetAbsolutePath(path string) (string, error) {
	if path == "" {
		return "", errors.New(i18n.T("util_path_is_empty"))
	}
	...
	if strings.HasPrefix(path, "~") {
		...
		if err != nil {
			return "", errors.New(i18n.T("util_could_not_resolve_home_dir"))
		}
	...
	if err != nil {
		return "", errors.New(i18n.T("util_could_not_get_absolute_path"))
	}
	...
	return "", fmt.Errorf(i18n.T("util_could_not_resolve_symlinks"), err)
}
...
func GetDefaultConfigPath() (string, error) {
	...
	if err != nil {
		return "", fmt.Errorf(i18n.T("util_could_not_determine_home_dir"), err)
	}
	...
	if _, err := os.Stat(defaultConfigPath); err != nil {
		...
		return "", fmt.Errorf(i18n.T("util_error_accessing_default_config_path"), err)
	}
