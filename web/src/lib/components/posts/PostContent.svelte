...
<article class="py-6">
	...
	{:else}
		<div class="space-y-4 pl-8 ml-8">
			<h1 class="inline-block text-4xl font-bold inherit-colors lg:text-5xl">
				{post.metadata.title}
			</h1>
			<PostMeta data={post.metadata} />
		</div>
		<div
			class="items-center py-8 mx-auto gap-8 max-w-7xl relative prose prose-slate dark:prose-invert"
		>
