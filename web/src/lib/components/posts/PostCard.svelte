...
<article
	class="group relative rounded-lg border bg-gray-800/50 p-6 shadow-sm transition-colors hover:bg-primary-500/50 {className}"
>
	<a href="/posts/{post.slug}" class="absolute inset-0" data-sveltekit-preload-data="off">
