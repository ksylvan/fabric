<script lang="ts">
	...
	import { sessionAPI } from '$lib/store/session-store';
	import { chatState, clearMessages, revertLastMessage, messageStore } from '$lib/store/chat-store';
...
<div class="p-1 m-1 mr-2">
	<div class="flex gap-2">
		<Button
			variant="outline"
			size="icon"
			aria-label="Revert Last Message"
